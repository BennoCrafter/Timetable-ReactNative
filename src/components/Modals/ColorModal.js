...
const ColorModal = ({ visible, onClose, onSelectColor, colorOptions, onNewColorOptions }) => {
  ...
  return (
    ...
    >
      <View style={[styles.container, modalStyles.modalContainer]}>
        <View style={[modalStyles.modalContent, isDarkMode ? darkModeStyle.backgroundTheme: []]}>
          <View style={modalStyles.buttonContainer}>
            ...
            >
              <Text style={[modalStyles.buttonText, isDarkMode ? darkModeStyle.fontColor: []]}>+</Text>
            </TouchableOpacity>
          </View>
          <Text style={[modalStyles.modalHeader, isDarkMode ? darkModeStyle.fontColor: []]}>Select a color</Text>
      ...
      >
        <NewColorModal onClose={() => setShowNewColorModal(false) } onNewColor={addNewColor} />
      </Modal>
    </Modal>
  );
};
